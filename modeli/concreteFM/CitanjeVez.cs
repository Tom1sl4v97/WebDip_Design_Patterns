        ...
        public override void provjeriDohvacenePodatke(string[] lines)
        {
            ...
            foreach (string line in lines)
            {
                ...
                try
                {
                    ...
                    {
                        BrojacGreske.Instance.dodajGreskeUcitavanjaCSVDatoteki("Navedeni ID veza: " + trenutniId + " već postoji u popisu vezova.");
                    }
                }
                catch (Exception e)
                {
                    BrojacGreske.Instance.dodajGreskeUcitavanjaCSVDatoteki("Neispravni redak: " + line + " u datoteci: " + NaziviDatoteka.Instance.vez + " GRESKA: " + e.Message);
                }
            }
        }
