...
namespace ttomiek_zadaca_1
{
    internal class PodaciDatoteka
    {
        ...
        private List<ZahtjevRezervacije> _listaZahtjevaRezervacije = new();
        ...
        public void postaviNovuListuZahtjevaRezervacije(List<ZahtjevRezervacije> novaLista)
        {
            _listaZahtjevaRezervacije = novaLista;
        }
    }
}
